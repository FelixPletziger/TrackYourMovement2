 ...
 */
public class PgsqlInsertTPTask extends AsyncTask<Void, Void, Void> {
    ...
    public PgsqlInsertTPTask(List<TrackPoint> data) {
        super();
        this.data=data;
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Log.e("PgsqlInsertTPTask","Verbunden zur PGSQL DB");
